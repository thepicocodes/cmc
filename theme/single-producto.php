...
<div class="w-full max-w-screen-xl mx-auto px-5">
    <section class="mt-24">
        ...
        <div class="mt-10 grid grid-cols-1 lg:grid-cols-[760px_1fr] gap-4">
            ...
            <div id="product-swiper" class="swiper product-swiper !w-full">
            ...
            <div class="w-full md:max-w-[464px] pt-8 md:px-9 pb-10">
                ...
                <span class="mt-2 text-h5 md:text-h2 text-gray-QG font-medium">RD$
                    <?php echo esc_html(get_field('precio')); ?></span>
                                ...
                                <div data-accordion class="rounded-[10px] py-2.5 px-5 bg-[#F8F8F8]">
                                    <button class="w-full flex flex-col gap-2.5">
                                        <div class="flex flex-row items-center gap-2.5">
                                            ...
                                            <h5 class="text-base font-lato font-bold text-gray-QG">
        ...
        if (!empty($terms)) {
            ...
            if ($related_products->have_posts()): ?>
                ...
                <div class="flex justify-center">
                    ...
                    ?>
                    <a href="/?s=&<?php echo $query_string; ?>"
                        class="rounded-lg mt-20 p-4 text-2xl text-white bg-green-modular">Ver todos</a>
                </div>
            <?php else: ?>
