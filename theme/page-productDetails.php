...
<div class="w-full max-w-screen-xl mx-auto px-5">
        ...
        <div class="w-full max-w-[760px]">
            ...
            <div class="mt-14">
                ...
                <div id="accordion-container" class="w-full mt-2.5 flex flex-col gap-2.5">
                    <div data-accordion>
                        <button class="w-full pt-5 px-5 pb-8 flex flex-col gap-2.5">
                            <div class="flex flex-row items-center gap-2.5">
                                ...
                                <h5 class="text-base font-bold text-gray-QG">Pregunta frecuente 1</h5>
                            </div>
                        </button>
    ...
    <section class="mt-24">
        ...
        <div class="flex justify-center">
            <button class="rounded-lg mt-20 p-4 text-white bg-green-modular">Ver todos</button>
        </div>
    </section>
</div>
