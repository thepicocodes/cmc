...
<div class="w-full max-w-screen-xl mx-auto px-5">
    ...
    <section class="mt-24">
        ...
        <div class="w-full mt-2 flex flex-col md:flex-row items-center">
        ...
        <div class="flex justify-center">
            <button class="rounded-lg mt-20 p-4 bg-yellow-QG">Ver todos</button>
        </div>
    </section>
    ...
    <section class="mt-24">
        ...
        <p class="mt-2 text-gray-QG text-m text-center font-medium">Vorem ipsum dolor sit amet, consectetur adipiscing
            elit
        </p>
    ...
    <section class="mt-24">
        ...
        <div id="testimonial-swiper" class="swiper testimonial-swiper h-[350px] mt-5">
            <div class="swiper-wrapper ">
                <div
                    class="swiper-slide rounded-2xl !grid grid-cols-1 md:grid-cols-3 gap-6 !h-[300px] mx-auto bg-yellow-20">

                    <div class="rounded-lg p-6 flex flex-col items-center justify-center text-center">
                        <span class="text-4xl font-bold text-[#602900]">550+</span>
                        <p class="text-brown-700 mt-2">Clientes satisfechos</p>
                    </div>

                    <div class="md:col-span-2 rounded-lg p-6 flex flex-col justify-center text-center">
    ...
    <section id="contacto"
        ...
        <div class="w-full max-w-[682px] py-14 md:px-10">
            <div class="rounded-2xl p-10 text-gray-QG backdrop-blur-xl bg-gray-100/75">
                ...
                <form action="get" class="mt-10">
                    <div class="flex w-full flex-col gap-10 md:flex-row">
                        <div class="flex w-full flex-col">
                            ...
                            <input type="text" name="Nombre"
                                class="border-1 mt-1 h-[60px] w-full rounded border-[#EAEAEA] p-5 outline-none placeholder:text-[#A0A0A0]">
                        </div>
                        <div class="flex w-full flex-col">
                            <label for="Name" class="text-body font-bold">Apellido:</label>
                            <input type="text" name="Nombre"
                                class="border-1 mt-1 h-[60px] w-full rounded border-[#EAEAEA] p-5 outline-none">
                        </div>
                    </div>
                    <div class="mt-10">
                    ...
                    <div class="mt-10 flex w-full flex-row items-center gap-10">
                        <div class="flex w-full flex-col">
                            <label for="Name" class="text-body font-bold">Mensaje:</label>
                            <div class="flex flex-col gap-x-10 md:flex-row md:items-center">
                                <input type="text" name="Message"
                                    class="border-1 mt-1 h-[60px] w-full rounded border-[#EAEAEA] p-5 outline-none">
                            </div>
                            <button
                                class="rounded w-fit h-[60px] mt-10 gap-x-2 p-[18px] inline-block flex-row items-center text-xl text-gray-QG font-medium bg-yellow-QG">
                                Enviar
                            </button>
                        </div>
                    </div>
