...
get_header();
$line_value = isset($_GET['line']) ? esc_attr($_GET['line']) : ''; 
?>
...
<div class="w-full max-w-screen-xl mx-auto px-5">
    ...
    <?php 
        if ($line_value === 'qg') {
            echo '<img src="' . get_template_directory_uri() . '/images/qg-head.jpeg" alt="Quality Guard" class="block w-full max-w-[1240px] h-[460px] object-cover object-center rounded-2xl mt-10">';
    ...
    <section class="mt-12">
        ...
        <div class="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-6 font-lato">
            ...
            $args = array(
                ...
                'posts_per_page' => 1,
                'paged' => $paged,
                's' => get_search_query(), // Use the search query
            );
            ...
            ?>
                <div class="col-span-full text-center text-gray-QG py-40">
                    No se encontraron resultados para "<?php echo get_search_query(); ?>".
                </div>
            <?php
            endif;
            ?>
            ...
            <div class="flex items-center justify-center space-x-2 mt-[56px]">
                <?php
                    ...
                    echo paginate_links(array(
                        ...
                        'prev_text' => '<svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-2 fill-black-primmary" viewBox="0 0 320 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s-12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5 45.3 0l-192 192z" /></svg>',
